  ...
  return (
    <div className="min-h-screen bg-bg-primary flex">
      ...
      <aside className="w-64 bg-white border-r border-border flex flex-col fixed h-screen">
        ...
        <div className="p-6 border-b border-border">
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              <h1 className="text-lg font-bold text-text-primary">StudyFlow</h1>
        ...
        <div className="border-t border-border p-4 space-y-3">
          <div className="bg-gradient-to-br from-gray-50 to-gray-100 rounded-xl p-3">
            <p className="text-xs text-text-secondary font-medium uppercase tracking-wide mb-1">Logged in as</p>
          ...
          <button
            ...
            className="w-full px-4 py-2.5 bg-danger/10 text-danger rounded-xl hover:bg-danger/20 transition-all duration-200 font-medium flex items-center justify-center gap-2"
          >
      ...
      <div className="flex-1 flex flex-col ml-64">
        {/* Top Navigation */}
        <nav className="bg-white/80 backdrop-blur-lg border-b border-border sticky top-0 z-40">
          <div className="px-8 py-4 flex justify-between items-center gap-6">
            ...
            <div className="flex items-center gap-3 flex-shrink-0">
              <div className="w-10 h-10 bg-gradient-to-br from-primary to-secondary rounded-full flex items-center justify-center text-white font-bold shadow-sm">
